            ...
            public void onPageFinished(final WebView webView, final String url) {
                if (url.startsWith(redirectURL)) {
                    ...
                    if (!gettingToken) {
                        ...
                        DNTConnect.getInstance().api.getToken("authorization_code", code, redirectURL, client_id, client_secret, new Callback<DNTConnectToken>() {

                            @Override
                            public void success(DNTConnectToken dntConnectToken, Response response) {
                                Utils.showToast(OAuthActivity.this, "Authorization success");
                                DNTConnect.getInstance().api.refreshToken("refresh_token", dntConnectToken.refresh_token, redirectURL, client_id, client_secret, new Callback<DNTConnectToken>() {
